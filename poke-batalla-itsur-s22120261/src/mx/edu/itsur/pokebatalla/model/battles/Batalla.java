...
do{
    ...
    private void seleccionarPokemon(Entrenador Atac) {
        ...
        System.out.println("");
        System.out.println("Selecciona tu  pokemon " + Atac.getNombre());
        ...
        Pokemon pokemonSeleccionado = Atac.getPokemonsCapturados()
                .get(Character.getNumericValue(auxLectura) - 1);
        Atac.setPokemonActual(pokemonSeleccionado);
    }
    ...
    private void cambiarPokemon(Entrenador entrenador) {
        System.out.println("Deseas cambiar a algun otro pokemon ? ");
